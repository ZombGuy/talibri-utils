// ==UserScript==
// @name         Cook Every Fish For TTF
// @description  Rakky's Talibri Enhancer modified by Zom
...
//I modified this code to work a little better with Chemo and Trio Dark
...
$(function() {
    ...
    function createDisplay(){
        ...
        html += '<div id="progressBarContainer" style="width: 50%; position: absolute; background-color: #111; display: flex; height: 33%;">';
        html += '<div id="progressBar" style="background-color: #99ccff; flex-direction: column; width: 0%;"></div></div>';
